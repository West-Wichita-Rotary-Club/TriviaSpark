...
export default function PresenterView() {
  ...
  const questions =
    hydratedEvent?.questions ?? (demoEvent.id === eventId ? demoQuestions : undefined);
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-wine-900 to-champagne-900 text-white overflow-hidden">
      ...
      <div
        className={`flex-shrink-0 border-b border-white/20 transition-all duration-300 ${isHeaderCollapsed ? 'p-2' : 'p-4'}`}
      >
        {/* Collapsed Header - Only show when collapsed */}
        {isHeaderCollapsed && (
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-lg font-bold text-champagne-200 truncate">{event.title}</h1>
            <Button
          ...
          <>
            ...
            <div className="flex items-start justify-between flex-wrap gap-4">
              <div className="flex-1 min-w-0">
                <h1
                  className="hidden sm:block text-2xl lg:text-4xl font-bold text-champagne-200 truncate"
                  data-testid="text-event-title"
                >
                  {event.title}
                </h1>
                <p
                  className="hidden sm:block text-sm lg:text-lg text-white/80 truncate"
              ...
              <div className="flex items-center space-x-4 text-right flex-shrink-0">
                <div className="text-center">
                  <div className="text-lg font-bold text-champagne-300">
                    {questions?.length || 0}
                  </div>
                ...
                <span className="text-sm text-champagne-300">
                  {gameState === 'question'
                    ? currentQuestionType === 'training'
                      ? `Training Question ${currentQuestionIndex + 1} of ${currentQuestions?.length || 0}`
                      : currentQuestionType === 'tie-breaker'
                        ? `Tie-breaker ${currentQuestionIndex + 1} of ${currentQuestions?.length || 0}`
      ...
      <div className="flex-1 flex items-center justify-center p-4 pb-20 min-h-0">
              ...
              <CardContent className="space-y-8">
                <div className="text-center space-y-6">
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl text-white leading-relaxed max-w-4xl mx-auto">
                    Time for a quick practice round! These training questions will help you warm up
                    and get comfortable with the trivia format before the main game begins.
                  </p>
                </div>
                <div className="bg-green-700/80 rounded-lg p-6 border border-green-400 max-w-5xl mx-auto">
                  ...
                  <p className="text-base md:text-lg lg:text-xl text-white text-center leading-relaxed">
                    Use these questions to practice the format, timing, and mechanics before the
                    real game starts. No points will be scored - this is just to help everyone get
                    comfortable!
                  </p>
                </div>
              </CardContent>
        ...
        {gameState === 'rules' && (
          <div
            className="flex-1 flex items-center justify-center w-full max-w-6xl px-4 py-2 min-h-0"
                ...
                <div className="text-left max-w-4xl mx-auto space-y-3 h-full flex flex-col justify-center">
                  <div className="flex items-start gap-4 p-3 lg:p-4 rounded-xl bg-wine-700/30 hover:bg-wine-600/40 transition-all duration-300">
                    ...
                    <p className="text-base lg:text-lg text-white leading-tight mt-1">
                      <strong className="text-champagne-300">No internet searches!!!</strong>{' '}
                      <span className="text-white/80">(Remember the 4-way test...)</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 lg:p-4 rounded-xl bg-wine-700/30 hover:bg-wine-600/40 transition-all duration-300">
                    ...
                    <p className="text-base lg:text-lg text-white leading-tight mt-1">
                      <strong className="text-champagne-300">20 seconds per question</strong>{' '}
                      <span className="text-white/80">allowed for a team answer.</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 lg:p-4 rounded-xl bg-wine-700/30 hover:bg-wine-600/40 transition-all duration-300">
                    ...
                    <p className="text-base lg:text-lg text-white leading-tight mt-1">
                      Write your <strong className="text-champagne-300">letter answer</strong>{' '}
                      <span className="text-white/80">on your whiteboard.</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 lg:p-4 rounded-xl bg-wine-700/30 hover:bg-wine-600/40 transition-all duration-300">
                    ...
                    <p className="text-base lg:text-lg text-white leading-tight mt-1">
                      Keep your{' '}
                      <strong className="text-champagne-300">correct answer held high</strong>{' '}
                      <span className="text-white/80">until scorekeeper has acknowledged it.</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-3 lg:p-4 rounded-xl bg-wine-700/30 hover:bg-wine-600/40 transition-all duration-300">
                    ...
                    <p className="text-base lg:text-lg text-white leading-tight mt-1">
                      Leave your{' '}
                      <strong className="text-champagne-300">marker, eraser and whiteboard</strong>{' '}
                      <span className="text-white/80">on your table when we finish.</span>
                    </p>
                  </div>
              ...
              <CardHeader className="relative z-10 flex-shrink-0">
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <CardTitle className="text-xl lg:text-3xl text-white drop-shadow-lg">
                    {currentQuestionType === 'training'
                      ? `Training Question ${currentQuestionIndex + 1}`
                      : currentQuestionType === 'tie-breaker'
                        ? `Tie-breaker ${currentQuestionIndex + 1}`
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-champagne-200 text-champagne-900 text-lg px-4 py-2"
                    >
                ...
                <div className="flex flex-col h-full min-h-0 gap-4 lg:gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="bg-black/80 backdrop-blur-sm rounded-xl p-6 lg:p-8 border border-white/20">
                      <h3
                        className={`font-bold leading-tight text-white break-words text-center ${
        ...
        {gameState === 'answer' && currentQuestion && (
          <div
            className="w-full max-w-7xl h-full flex flex-col gap-6 overflow-auto"
            data-testid="view-answer"
          >
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="text-center flex items-center justify-center w-full">
                    <div className="w-full max-w-6xl">
                      <p
                        className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold text-white break-words leading-tight px-4"
                      ...
                      >
                        {(() => {
                          ...
                          return answerLetter
                            ? `${questionNumber}.${answerLetter} ${currentQuestion.correctAnswer}`
