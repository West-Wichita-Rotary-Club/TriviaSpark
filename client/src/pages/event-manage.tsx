  ...
  const onSubmit = (data: EventFormData) => {
    ...
    const processedData = {
      ...
      eventDate: data.eventDate
        ? createDateInCST(data.eventDate, data.eventTime).toISOString()
        : data.eventDate,
    };
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setEditForm({ ...editForm, timeLimit: parseInt(e.target.value) || 30 })
              }
              className="mt-1 bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary"
              min={5}
              max={300}
          ...
          <div>
            ...
            >
              <SelectTrigger
                className="mt-1 bg-background border-border text-foreground focus:border-primary focus:ring-1 focus:ring-primary"
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setEditForm({ ...editForm, orderIndex: parseInt(e.target.value) || 1 })
              }
              className="mt-1 bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary"
              min={1}
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            {editForm.backgroundImageUrl && (
              <Button
                ...
                size="sm"
                onClick={() => {
                  setEditForm({ ...editForm, backgroundImageUrl: '' });
          ...
          <div className="border border-border rounded-md p-3 space-y-3 bg-muted/50">
            ...
            {unsplashError && (
              <p className="text-sm text-destructive" data-testid="error-unsplash">
                {unsplashError}
              </p>
            )}
            {unsplashResults.length > 0 && (
              <div
                ...
                data-testid="grid-unsplash-results"
              >
                {unsplashResults.map((img, i) => (
                  ...
                  >
                    <img
                      src={img.urls.thumb}
                      alt={img.alt_description || img.description || 'img'}
            ...
            {selectedImage && (
              <p
                ...
                data-testid="text-unsplash-attribution"
              >
                Photo by{' '}
                <a
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="unsplashImageId" className="text-xs text-foreground font-medium">
                  Unsplash Image ID
                </Label>
                <Input
                  id="unsplashImageId"
                  ...
                  onChange={(e) =>
                    setEventImageForm((prev) => ({ ...prev, unsplashImageId: e.target.value }))
                  }
              ...
              <div className="space-y-2">
                <Label htmlFor="sizeVariant" className="text-xs text-foreground font-medium">
                  Size Variant
                </Label>
                <Select
                  value={eventImageForm.sizeVariant}
                  onValueChange={(value) =>
                    setEventImageForm((prev) => ({ ...prev, sizeVariant: value }))
                  }
                >
              ...
              <div className="space-y-2">
                <Label htmlFor="usageContext" className="text-xs text-foreground font-medium">
                  Usage Context
                </Label>
                <Select
                  value={eventImageForm.usageContext}
                  onValueChange={(value) =>
                    setEventImageForm((prev) => ({ ...prev, usageContext: value }))
                  }
                >
                  <SelectTrigger className="text-xs bg-background border-border text-foreground focus:border-primary focus:ring-1 focus:ring-primary">
              ...
              <div className="space-y-2">
                <Label htmlFor="searchContext" className="text-xs text-foreground font-medium">
                  Search Context
                </Label>
                <Input
                  id="searchContext"
                  ...
                  onChange={(e) =>
                    setEventImageForm((prev) => ({ ...prev, searchContext: e.target.value }))
                  }
            ...
            {eventImageData?.eventImage && (
              <div className="border-t pt-4">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                  <div>
                    Created: {new Date(eventImageData.eventImage.createdAt).toLocaleString()}
                  </div>
                  ...
                  {eventImageData.eventImage.imageUrl && (
                    <div className="col-span-2">
                      <img
                        src={
                          eventImageData.eventImage.thumbnailUrl ||
                          eventImageData.eventImage.imageUrl
                        }
                        alt="Current image"
                ...
                <CardContent>
                  {questions.length === 0 ? (
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm">
                        Generate AI questions or add your own to get started
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex gap-2 ml-4">
                                <Button
                                  onClick={() =>
                                    setLocation(`/events/${event.id}/manage/trivia/${question.id}`)
                                  }
                                  variant="outline"
                                  size="sm"
