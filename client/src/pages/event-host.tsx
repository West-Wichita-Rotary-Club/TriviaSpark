            ...
            <Card data-testid="card-teams-participants">
              <CardHeader>
                <CardTitle
                  ...
                  data-testid="text-teams-participants-title"
                >
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge
                            variant="secondary"
                            data-testid={`badge-question-difficulty-${index}`}
                          >
                            {question.difficulty}
                          </Badge>
                        </div>
                    ...
                    >
                      <div>
                        <span
                          ...
                          data-testid={`text-participant-name-${index}`}
                        >
                          {participant.name}
                        </span>
                      ...
                      <Badge
                        ...
                        data-testid={`badge-participant-status-${index}`}
                      >
