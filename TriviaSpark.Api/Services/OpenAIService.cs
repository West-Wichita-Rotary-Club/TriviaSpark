...
/// <summary>
/// Interface for AI-powered trivia question generation using OpenAI.
/// </summary>
public interface IOpenAIService
{
    /// <summary>
    /// Generates trivia questions using OpenAI GPT-4o for a given topic and difficulty.
    /// </summary>
    /// <param name="eventId">The event identifier for context.</param>
    /// <param name="topic">The subject area for generated questions.</param>
    /// <param name="difficulty">Difficulty level (easy, medium, hard, mixed).</param>
    /// <param name="count">Number of questions to generate.</param>
    /// <param name="eventContext">Optional context about the event for more relevant questions.</param>
    /// <returns>A list of generated trivia questions.</returns>
...
/// <summary>
/// Service that integrates with OpenAI GPT-4o to generate trivia questions.
...
public class OpenAIService : IOpenAIService
{
    ...
    /// <summary>
    /// Initializes the OpenAI service with HTTP client, configuration, and logger.
    /// </summary>
...
/// <summary>
/// Represents a trivia question generated by OpenAI.
/// </summary>
...
{
    /// <summary>List of completion choices returned by the API.</summary>
...
public class Choice
{
    /// <summary>The message content of this choice.</summary>
    public Message Message { get; set; } = new();
}

/// <summary>
/// Represents a message in an OpenAI API response.
/// </summary>
